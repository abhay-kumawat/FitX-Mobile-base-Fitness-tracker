...
def migrate():
    ...
    queries = [
        ...
        "ALTER TABLE workout_sessions ADD COLUMN planned_date VARCHAR;",
        "ALTER TABLE workout_plans ADD COLUMN master_event_id VARCHAR(36);",
        "ALTER TABLE workout_plans ADD COLUMN is_recurring BOOLEAN DEFAULT 0;",
        "ALTER TABLE workout_plans ADD COLUMN recurrence_rule VARCHAR;",
        "ALTER TABLE workout_plans ADD COLUMN planned_date VARCHAR;",
        "ALTER TABLE workout_plans ADD COLUMN template_origin_id INTEGER;",
