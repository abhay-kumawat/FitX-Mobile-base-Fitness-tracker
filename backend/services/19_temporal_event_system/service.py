...
from backend.services.19_temporal_event_system.engine.state_machine import StateMachineEngine
from backend.services.19_temporal_event_system.engine.recurrence import RecurrenceEngine
from backend.services.19_temporal_event_system.engine.timeline import TimelineQueryEngine
from backend.services.19_temporal_event_system.engine.audit import AuditEngine
from backend.services.19_temporal_event_system.engine.analytics_hooks import AnalyticsEngine
...
class TemporalEventService:
    ...
    def get_sync_updates(
        ...
        """
        Incremental sync endpoint for mobile offline clients.
        Returns all events updated or deleted since last_sync_at.
        """
