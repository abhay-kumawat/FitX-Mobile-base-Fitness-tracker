...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col gap-8 pb-32 animate-smooth-reveal">
      ...
      <section className="relative overflow-hidden p-6 sm:p-8 rounded-3xl bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white border border-slate-800 shadow-2xl space-y-6">
        ...
        <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-black tracking-wide">
          ...
          <span>FitX AI Platform 2.0 • Powered by Google Gemini</span>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs sm:text-sm text-slate-300 font-medium leading-relaxed max-w-xl">
            18 microservices working seamlessly to deliver dynamic workout adaptations, real-time HRV telemetry, budget-aware meal plans, and Google Authenticator security.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
          ...
          >
            ...
            <span>{isAuthenticated ? `Welcome, ${user?.name}` : "Sign In with Google"}</span>
          </button>
      ...
      {/* Google Authenticator & Security Highlight Banner */}
      <section className="p-5 rounded-3xl bg-white border border-slate-200 shadow-sm space-y-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">
                Protect your fitness telemetry & biometric data with Google 2-Factor Authentication.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200 flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 font-semibold mt-0.5">
                One-click passwordless login using your Google account with instant JWT session issuance.
              </p>
            </div>
          </div>
          ...
          <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200 flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 font-semibold mt-0.5">
                6-digit timed OTP codes updated every 30 seconds for maximum security.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <span>Open Google Authenticator Modal</span>
        </button>
      </section>

      {/* 8 Integrated Feature Hubs Grid */}
      <section className="space-y-4">
        <div className="flex items-center justify-between px-1">
          <div>
            <h2 className="text-lg font-black text-slate-900 flex items-center gap-2">
              <Layers className="w-5 h-5 text-emerald-600" /> Platform Architecture
            </h2>
            <p className="text-xs text-slate-500 font-medium">8 specialized fitness & recovery services</p>
          </div>
        </div>
      ...
      <footer className="text-center space-y-3 pt-4 border-t border-slate-200">
        ...
        <div className="flex justify-center items-center space-x-4 text-[11px] font-bold text-slate-500">
          <Link href="/landing" className="hover:text-emerald-600">Landing Page</Link>
          <span>•</span>
          <Link href="/" className="hover:text-emerald-600">App Hub</Link>
          <span>•</span>
