...
export const metadata: Metadata = {
  title: "FitX AI - Hyper-Personalized Mobile Fitness & Recovery",
  description: "Elite Mobile Web App featuring AI Adaptive Workouts, Telemetry Readiness, Smart Meal & Todo Tracker, and Exercise Constellations.",
};
